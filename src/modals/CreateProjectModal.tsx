...
const CreateProjectModal = ({ closeModal }: CreateProjectModalProps): any => {
        ...
        <FormikProvider value={formik}>
          ...
          >
            <StyledFromSection>
              <StyledUploadLogo
                name={'logo_image'}
                onChange={async (e: any) => await handleChangeFile(e, 'logo_image')}
              ...
              <StyledUploadImg
                name={'banner_image'}
                onChange={async (e: any) => await handleChangeFile(e, 'banner_image')}
              ...
              <StyledUploadImg
                ...
                onChange={async (e: any) => await handleChangeFile(e, 'background_image')}
