  ...
  return (
    <>
      ...
      <div style={{ display: 'flex' }}>
      	{selectedFiled.files.map((item: any, index: number) => <StyledImageWrapper>
          {selectedFiled.uploaded_files[index] ? <img src={selectedFiled.uploaded_files[index]} width="100px" /> : item.name}
        </StyledImageWrapper>)}
      </div>
